...
instance Comap (BA (Bazaar Map a) t) where comap = premap_comap
...
instance Comap (BA (Bazaar Pure a) t) where comap = premap_comap
...
instance Comap (BA (Bazaar Apply a) t) where comap = premap_comap
...
instance Comap (BA (Bazaar Applicative a) t) where comap = premap_comap
